...
function [repeat_dialog,selslave,selectid,MID,DID,SLA,SLP,SLST] = set_etl_slave_el2xxx(selslave,selectid,MID,DID,SLA,SLP,SLST)
  check_values = 0;
  fd = mopen([getenv('ETLPATH')+'/modules/etherlab_base/src/tcl/'+'etl_scicos_el2xxx.tcl'],'r');
  txt = mgetl(fd,-1);
  mclose(fd);
  
  initvalues = ['array set slavestring { 0 EL2004V1 1 EL2004V2 2 EL2008 3 EL2032V1 4 EL2032V2 5 EL2602 6 EL2612 7 EL2622 8 EL2624}' 
		'array set slavestate { 0 0 1 0 2 0 3 1 4 1 5 0 6 0 7 0 8 0}'; 
