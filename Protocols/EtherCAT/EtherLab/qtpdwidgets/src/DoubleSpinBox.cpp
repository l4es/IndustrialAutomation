...
void DoubleSpinBox::stepBy(int steps)
{
    if (editing) {
        ...
        double v = internalValue + steps * singleStep();
        if (v > maximum())
            v = maximum();
        else if (v < minimum())
            v = minimum();
 ...
 */
void DoubleSpinBox::setEditing(bool e)
{
    if (editing != e) {
 ...
 */
void DoubleSpinBox::setInternalValue(double v)
{
    if (v != internalValue) {
        internalValue = v;
 ...
 */
void DoubleSpinBox::updateFromInternal()
{
 ...
 * changes.
 */
void DoubleSpinBox::notify(PdCom::Variable *pv)
{
    double value;
