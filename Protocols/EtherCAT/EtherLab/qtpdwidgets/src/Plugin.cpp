...
QString Plugin::domXml() const
{
    ...
    xml = "<ui language=\"c++\">\n"
        "  <widget class=\"Pd::" + widgetClassName + "\" "
        "name=\"pd" + widgetClassName + "\" />\n"
        "</ui>\n";
#else
    xml = "<widget class=\"Pd::" + widgetClassName + "\" "
        "name=\"pd" + widgetClassName + "\" />\n";
#endif
...
{
    return "QtPdWidgets/" + widgetClassName + ".h";
}
