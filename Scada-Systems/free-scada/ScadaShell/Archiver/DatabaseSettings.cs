...
namespace FreeSCADA.Archiver
{
	...
	public class DatabaseSettings
	{
		...
		public void Load()
		{
			using (System.IO.Stream ms = _project["settings/archiver/database.cfg"])
			{
		...
		public void Save()
		{
			using (System.IO.MemoryStream ms = new System.IO.MemoryStream())
			{
                ...
                _project.SetData("settings/archiver/database.cfg", ms);
			}
		}
		...
		public String CreateConnectionString()
		{
			...
			{
				DbProviderFactory dbProviderFactory = DatabaseFactory.Get(DbProvider);
