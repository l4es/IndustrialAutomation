...
namespace FreeSCADA.Common
{
	...
	public class Project
	{
   		...
   		public void Load(string fileName)
        {
			...
			{
				if (System.Windows.MessageBox.Show("Project version is differ from current version\n\rdo you whant try to convert?"
                    , "Caution!", System.Windows.MessageBoxButton.YesNo) == System.Windows.MessageBoxResult.Yes)
				{
					ConvertProject();
					if (Version != CurrentVersion)
						System.Windows.MessageBox.Show("Project version stil differ from current version.", "Conversion Result");
				}
			}
			FireProjectLoaded();
		}
