...
static asn_TYPE_tag2member_t asn_MAP_ConfirmedResponsePdu_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* getNameList at 143 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 1, 0, 0 }, /* read at 144 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 1, 0, 0 }, /* write at 145 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 1, 0, 0 }, /* getVariableAccessAttributes at 146 */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 1, 0, 0 }, /* defineNamedVariableList at 147 */
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 1, 0, 0 }, /* getNamedVariableListAttributes at 148 */
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 1, 0, 0 } /* deleteNamedVariableList at 150 */
};
