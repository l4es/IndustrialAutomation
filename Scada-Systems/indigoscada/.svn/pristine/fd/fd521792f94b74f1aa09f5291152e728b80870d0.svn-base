...
static asn_TYPE_tag2member_t asn_MAP_ConfirmedServiceRequest_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 0, 0, 0 }, /* getNameList at 130 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 1, 0, 0 }, /* read at 131 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 2, 0, 0 }, /* write at 132 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 3, 0, 0 }, /* getVariableAccessAttributes at 133 */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 4, 0, 0 }, /* defineNamedVariableList at 134 */
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 5, 0, 0 }, /* getNamedVariableListAttributes at 135 */
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 6, 0, 0 } /* deleteNamedVariableList at 139 */
};
