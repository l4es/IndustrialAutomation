...
// required includes
#include "wx/keybinder/keybinderdef.h"
#include "wx/panel.h"
#include "wx/dialog.h"
...
if (!key.compare(_T("i"))) return; // workaround to get rid of strange "i" shortcut for duplication of elements
...
#define wxKEYBINDER_NO_DESC_FIELD               32
...
public:     // import commands (to call BEFORE ShowModal):
    ...
    virtual void ImportMenuBarCmd(wxMenuBar *menuitems,
                                const wxString &rootname = _("Menu bar"));
    ...
    virtual void ImportKeyProfileCmd(const wxKeyProfile &toimport,
                                const wxString &rootname = _("Commands"));
