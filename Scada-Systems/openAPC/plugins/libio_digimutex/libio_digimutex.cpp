...
static char                 flowImage[]="";
static char                 libname[]="Mutual Exclusion";
...
OAPC_EXT_API unsigned long  oapc_set_digi_value(void *instanceData,unsigned long input,unsigned char value)
{
   ...
   if (value==1)
   {
      memset(data->currDigi,0,MAX_NUM_IOS);
      data->currDigi[input]=1;
   }
   else if (value==0)
   {
      memset(data->currDigi,1,MAX_NUM_IOS);
      data->currDigi[input]=0;
   }
