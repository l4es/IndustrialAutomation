...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxBitmap, wxFlatNotebookImageList, LIBOAPC_EXT_API);
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxWindow*, wxWindowPtrArray, LIBOAPC_EXT_API);
...
#define wxFNB_TABS_DISABLED         0x10000000
...
class LIBOAPC_EXT_API wxFlatNotebook : public wxPanel
{
public:
...
*/
class LIBOAPC_EXT_API wxPageInfo
{
private:
	// Members
	/// Page caption
...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxPageInfo, wxPageInfoArray, LIBOAPC_EXT_API);
...
* \brief Notebook page
*/
class LIBOAPC_EXT_API wxPageContainer : public wxPanel
{
protected:
...
*/
class LIBOAPC_EXT_API wxFlatNotebookEvent : public wxNotifyEvent
{
...
DECLARE_EXPORTED_EVENT_TYPE(LIBOAPC_EXT_API, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CHANGED, 50000)
DECLARE_EXPORTED_EVENT_TYPE(LIBOAPC_EXT_API, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CHANGING, 50001)
DECLARE_EXPORTED_EVENT_TYPE(LIBOAPC_EXT_API, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CLOSING, 50002)
DECLARE_EXPORTED_EVENT_TYPE(LIBOAPC_EXT_API, wxEVT_COMMAND_FLATNOTEBOOK_CONTEXT_MENU, 50003)
DECLARE_EXPORTED_EVENT_TYPE(LIBOAPC_EXT_API, wxEVT_COMMAND_FLATNOTEBOOK_PAGE_CLOSED, 50004)
