...
<script type="text/javascript">
  ...
  function saveDataSourceImpl() {
      DataSourceEditDwr.saveASCIIFileDataSource($get("dataSourceName"), $get("dataSourceXid"), $get("updatePeriods"),
              $get("updatePeriodType"),$get("filePath"), $get("quantize"), saveDataSourceCB);
  }
  ...
  function savePointImpl(locator) {
      ...
      DataSourceEditDwr.saveASCIIFilePointLocator(currentPoint.id, $get("xid"), $get("name"), locator, savePointCB);
  }
