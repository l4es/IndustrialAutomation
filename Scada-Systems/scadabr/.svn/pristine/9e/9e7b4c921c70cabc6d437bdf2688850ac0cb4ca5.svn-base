...
public class StripEntities {
     ...
     *
     * @param bareEntity String entity to convert convert. must have lead & and
     * trail ; stripped; may have form: #x12ff or #123 or lt or nbsp style
     * entity. Works faster if entity in lower case.
     * @param howToTranslateNbsp char you would like &nbsp translated to,
     * usually ' ' or (char) 160
     *
     ...
     * trail ; stripped; may be a #x12ff or #123 style entity. Works faster if
     ...
     * @param translateNbspTo char you would like &nbsp; translated to, usually
     * ' ' or (char) 160 .
     *
     ...
     *
     * @param possBareEntityWithSemicolon string that may hold an entity. Lead &
     * must be stripped, but may optionally contain text past the ;
     *
     ...
     * &hearts; &#123; and &#xffff; &nbsp; -> 160. null input returns null.
     * @noinspection WeakerAccess
     ...
     * @see #stripHTMLEntities(String,char)
     * @deprecated stripNbspShould no longer be necessary.
     * stripEntities(String,char) now lets you specify directly the translation
     * of nbsp you want.
     */
    @Deprecated
     ...
     * @param possBareEntityWithSemicolon string that may hold an entity. Lead &
     * must be stripped, but may optionally contain text past the ;
     * @param translateNbspTo char you would like nbsp translated to, usually '
     * ' or (char) 160 .
     *
     * @return corresponding unicode character, or 0 if the entity is invalid.
     * @noinspection WeakerAccess
    ...
    /**
     * Removes tags from HTML leaving just the raw text. Leaves entities as is,
     * e.g. Presumes perfectly formed HTML. <b>
     * </b> <i> </i>
     * <tr xxx>
