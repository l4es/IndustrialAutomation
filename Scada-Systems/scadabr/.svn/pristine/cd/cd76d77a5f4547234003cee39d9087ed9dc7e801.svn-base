...
public class StateChangeCountDetectorRT extends TimeoutDetectorRT {
    ...
    /**
     * State field. The point values that have accumulated so far. Each call to
     * pointChanged will drop off the values beyond the duration.
     */
    private final List<PointValueTime> pointValues = new LinkedList<PointValueTime>();

    /**
     * State field. Whether the state has been detected or not. This field is
