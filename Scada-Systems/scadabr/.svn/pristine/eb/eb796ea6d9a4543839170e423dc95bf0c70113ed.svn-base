...
public class OPCTest3 {
	...
	private static void dumpLeaf(String prefix, Leaf leaf) {
		System.out.println(prefix + "Leaf: " + leaf.getName() + " ["
				+ leaf.getItemId() + "]");
	}
...
//			}
	...
	private static void browseTree(String prefix, TreeBrowser treeBrowser,
			Branch branch) throws IllegalArgumentException,
