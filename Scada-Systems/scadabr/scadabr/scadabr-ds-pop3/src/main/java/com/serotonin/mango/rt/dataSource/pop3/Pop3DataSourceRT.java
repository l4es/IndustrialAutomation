...
public class Pop3DataSourceRT extends PollingDataSource<Pop3DataSourceVO> {
    ...
    public void doPoll(long time) {
        ...
        try {
            ...
            for (Message message : messages) {
                ...
                try {
                    ...
                    if (messageReadError == null) {
                        messageReadError = new LocalizableMessageImpl("common.default", e.getMessage());
                    }
                    continue;
                } finally {
            ...
            raiseEvent(INBOX_EXCEPTION_EVENT, time, false, new LocalizableMessageImpl("common.default", e.getMessage()));
        } finally {
            try {
                if (folder != null) {
                    folder.close(true);
