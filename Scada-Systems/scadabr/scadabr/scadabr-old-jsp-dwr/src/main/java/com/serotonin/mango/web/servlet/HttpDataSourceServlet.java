...
import br.org.scadabr.cache.ObjectCreator;
import br.org.scadabr.cache.ThreadSafeCache;
...
public class HttpDataSourceServlet extends HttpServlet {
    ...
    public static final ThreadSafeCache<SimpleDateFormat> BASIC_SDF_CACHE = new ThreadSafeCache<>(
    ...
    public static final ThreadSafeCache<SimpleDateFormat> TZ_SDF_CACHE = new ThreadSafeCache<>(
            new ObjectCreator<SimpleDateFormat>() {
                public SimpleDateFormat create() {
    ...
    private void addData(HttpReceiverData data, String name, String value, String time) {
        ...
        if (timestamp == 0 && time != null) // Check the given date.
        {
