...
public class FlexBuilderComponent extends HtmlComponent {
    ...
    public static ImplDefinition DEFINITION = new ImplDefinition("flexBuilder",
            "FLEX_BUILDER", "graphic.flexBuilder", null);
    ...
    private void createContent() {
        ...
        sb
                .append("codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0' ");

        sb.append("width='" + width + "' height='" + height + "'>");

        sb
                .append("<param name='movie'  value='builder/ScadaBRFlexBuilder.swf' /> ");
        ...
        sb.append("' quality='high' bgcolor='#ffffff' width='" + width
                + "' height='" + height + "' ");
        sb
                .append("type='application/x-shockwave-flash' pluginspage='http://www.macromedia.com/go/getflashplayer'>");
        sb.append("</embed>");
        sb.append("</object>");
