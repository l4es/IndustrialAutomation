 ...
 * @author Matthew Lohbihler
 */
abstract public class PointComponent<T extends PointValueTime> extends ViewComponent {
    ...
    abstract public void addDataToModel(Map<String, Object> model, T pointValue);
