...
], function (declare, lang, Tree, Button, JsonRest, DnDSource, OnDemandGrid, Keyboard, Selection, request, Memory, Observable, dndSource, DnD, JsonService, fx, timing, DataPointChart, Dialog, date, dateLocale, BorderContainer) {

    return declare("scadabr/desktop/WatchListsView", [BorderContainer], {
